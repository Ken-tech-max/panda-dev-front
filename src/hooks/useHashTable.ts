...
export async function fetchHashTable(
  ...
  for (let index = 0; index < metadataAccounts.length; index++) {
    ...
    console.log("value", accountInfo.value);
    // if( typeof accountInfo.value == typeof anchor.web3.AccountInfo<Buffer> ){
      let value:any = accountInfo.value;
      const metadata: any = new Metadata(hash.toString(), value);
